...
uniform vec2      color_texture_sz;      // tex size
...
void main()
{
float offsetx1 = 1.0 / color_texture_pow2_sz.x;
float offsety1 = 1.0 / color_texture_pow2_sz.y;
float offsetx2 = 2.0 / color_texture_pow2_sz.x;
float offsety2 = 2.0 / color_texture_pow2_sz.y;
